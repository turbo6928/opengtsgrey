...
The MySQL JDBC driver (mysql-connector-java-3.1.7-bin.jar) may be copied to this
...
Jars       : mysql-connector-java-3.1.7-bin.jar

Jars Should be copied to the following directories:
