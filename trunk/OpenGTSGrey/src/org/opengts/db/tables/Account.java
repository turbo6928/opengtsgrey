    ...
    implements UserInformation
{
    ...
    public static final PasswordHandler MD5PasswordHandler = new PasswordHandler() {
        ...
        public boolean checkPassword(String md5Pass, String tablePass) {
            if (StringTools.isBlank(tablePass)) {
                return false; // login not allowed for accounts with no password
            } else
            if (md5Pass == null) {
            ...
            if (md5Pass.equals("") && tablePass.equals(Account.BLANK_PASSWORD)) {
                return true; // blank password is ok
            } else
            if (md5Pass.equals(this.encodePassword(tablePass))) { // encode table password!
                return true; // passwords match
            } else {
                return false; // password does not match
            }
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(AccountType.class,a.getAccountType()) : EnumTools.getDefault(AccountType.class);
    }
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(GeocoderMode.class,a.getGeocoderMode()) : EnumTools.getDefault(GeocoderMode.class);
    }
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(SpeedUnits.class,a.getSpeedUnits()) : EnumTools.getDefault(SpeedUnits.class);
    }
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(DistanceUnits.class,a.getDistanceUnits()) : EnumTools.getDefault(DistanceUnits.class);
    }
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(TemperatureUnits.class,a.getTemperatureUnits()) : EnumTools.getDefault(TemperatureUnits.class);
    }
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(VolumeUnits.class,a.getVolumeUnits()) : EnumTools.getDefault(VolumeUnits.class);
    }
    ...
    public enum EconomyUnits implements EnumTools.StringLocale, EnumTools.IntValue {
        ...
        KPL         (1, I18N.getString(Account.class,"Account.economy.kpl","kpl"), 1.0                                                        ); // default
        // ---
        private int         vv = 0;
        private I18N.Text   aa = null;
        private double      mm = 1.0;
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(EconomyUnits.class,a.getEconomyUnits()) : EnumTools.getDefault(EconomyUnits.class);
    }
    ...
    **/
    ...
    {
        return (a != null)? EnumTools.getValueOf(LatLonFormat.class,a.getLatLonFormat()) : EnumTools.getDefault(LatLonFormat.class);
    }
  ...
  //public static final String FLD_newUserRoleID            = "newUserRoleID";
    public static final DBField FieldInfo[] = {
      ...
      //new DBField(FLD_newUserRoleID       , String.class  , DBField.TYPE_STRING(32)  , "Default New User Role"     , "edit=2"),
        // Common fields
        newField_isActive(),
    ...
    /* retur true if this Account has an "admin" user */
    ...
    **/
    ...
    public BasicPrivateLabel getPrivateLabel()
    {
        if (this.privateLabel == null) {
            String hostName = this.getPrivateLabelName();
            this.privateLabel = BasicPrivateLabelLoader.getPrivateLabel(hostName);
            if (this.privateLabel == null) {
                Print.logWarn("PrivateLabel not defined! [" + hostName + "]");
    ...
    /* return list of all Account IDs (NOT SCALABLE) */
    public static String[] getAllAccounts(DBSelect<Account> dsel)
        throws DBException
    {
    ...
    **/
    public static Account createNewAccount(String acctID)
        throws DBException
    {
        return Account.createNewAccount(acctID, null);
    }
    ...
    **/
    ...
    private static final String ARG_ARCHIVE[]   = new String[] { "archive"           };
    ...
    private static void usage()
    {
        ...
        Print.logInfo("  -list           List all Accounts and owned Devices");
    ...
    public static void main(String argv[])
    {
        ...
        if (RTConfig.hasProperty(ARG_LIST)) {
            //String listType = RTConfig.getString(ARG_LIST,"");
            opts++;
            try {
                String acctList[] = Account.getAllAccounts();
                for (int a = 0; a < acctList.length; a++) {

                    /* specific Account? */
                    if (hasAccountID && !acctID.equals(acctList[a])) {
                        // specific account requested, and accountID doesn't match
                        continue;
                    }

                    /* get account */
                    Account account = Account.getAccount(acctList[a]); // may return null
                    if (account == null) {
                    ...
                    Print.sysPrintln("");
                    {
                        ...
                        sb.append("Account: " + acctList[a] + " - " + account.getDescription());
                        // inactive,sysAdmin, etc
                        sb.append(" [");
                        int opt = 0;
                        if (opt++ > 0) { sb.append(","); }
                        sb.append("active=" + account.isActive());
                        if (opt++ > 0) { sb.append(", "); }
                        sb.append("hasAdminUser=" + account.hasAdminUser()); 
                        if (account.isSystemAdmin()) { 
                            if (opt++ > 0) { sb.append(", "); }
                            sb.append("isSysAdmin=true"); 
                        }
                        sb.append("]");
                        // invalid ID
                        if (!AccountRecord.isValidID(acctList[a])) {
                            sb.append(" (ID may contain invalid characters)");
                        }
                    ...
                    /* rules */
                    //try {
                    //    String ruleList[] = Rule.getRuleIDs(acctList[a]);
                    ...
                    Print.sysPrintln("  > Default Device Auth: " + DBConfig.GetDefaultDeviceAuthorization(acctList[a]));

                    /* devices */
                    OrderedSet<String> devList = Device.getDeviceIDsForAccount(acctList[a], null);
                    for (int d = 0; d < devList.size(); d++) {
                        ...
                        if (device == null) {
                            ...
                            //try {
                            //    ruleNames = RuleList.getRulesForDevice(acctList[a],devId,-1,true);
                            //} catch (Throwable th) {
                            //    // ignore
                            //}
                            if ((ruleNames != null) && (ruleNames.length > 0)) {
                                ...
                                for (int r = 0; r < ruleNames.length; r++) {
                                    if (r > 0) { sb.append(", "); }
                                    sb.append(ruleNames[r]);
                                }
                                Print.sysPrintln("    > Rules: " + sb);
                            }
                        }
                    }
