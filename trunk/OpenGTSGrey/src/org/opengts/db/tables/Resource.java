    ...
    extends AccountRecord<Resource>
{
    ...
    public static final String TYPE_PROPERTIES              = "properties";         // value is opague (defined by properties)
    ...
    public static String[] getResourcesForAccount(String acctId)
        throws DBException
    {
        ...
        dwh.append(dwh.EQ(Resource.FLD_accountID,acctId));
    ...
    // does not return null
    public static String[] getResources(DBSelect<Resource> dsel)
        throws DBException
    {
