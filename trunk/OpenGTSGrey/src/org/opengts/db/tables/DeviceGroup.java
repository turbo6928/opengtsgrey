    ...
    extends GroupRecord<DeviceGroup>
{
    ...
    public static String[] GetTitles(Locale loc) 
    {
        ...
        return new String[] {
            i18n.getString("DeviceGroup.title.singular", "Device Group"),
            i18n.getString("DeviceGroup.title.plural"  , "Device Groups"),
        };
    }
    ...
    public OrderedSet<String> getDevices(User userAuth)
        throws DBException
    {
        String acctId  = this.getAccountID(); // TODO: matches "userAuth.getAccountID()"?
        String groupId = this.getGroupID();
        return DeviceGroup.getDeviceIDsForGroup(acctId, groupId, userAuth, -1L);
    }

    /* return list of all Devices within the specified DeviceGroup (NOT SCALABLE BEYOND A FEW HUNDRED DEVICES) */
    public static OrderedSet<String> getDeviceIDsForGroup(String acctId, String groupId, User userAuth)
        throws DBException
    {
        return DeviceGroup.getDeviceIDsForGroup(acctId, groupId, userAuth, -1L);
    }
    ...
    /* return list of all Devices within the specified DeviceGroup (NOT SCALABLE BEYOND A FEW HUNDRED DEVICES) */
    public static OrderedSet<String> getDeviceIDsForGroup(String acctId, String groupId, User userAuth, long limit)
        throws DBException
    {
        ...
        /* "All"? */
        if (groupId.equalsIgnoreCase(DeviceGroup.DEVICE_GROUP_ALL)) {
            return Device.getDeviceIDsForAccount(acctId, userAuth);
        }
    ...
    public static String[] getDeviceGroupsForDevice(String acctId, String deviceId)
        throws DBException
    {
        ...
        if (RTConfig.hasProperty(ARG_LIST)) {
            ...
            if (hasGroupID) {
                if (!groupExists) {
                    ...
                    try {
                        OrderedSet<String> devList = DeviceGroup.getDeviceIDsForGroup(accountID, groupID, null, -1L);
                        if (devList.size() <= 0) {
