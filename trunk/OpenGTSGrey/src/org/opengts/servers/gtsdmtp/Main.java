...
public class Main
{
    ...
    public  static final String DMTP_1ST_SESSION_NEG    = DEVICE_CODE + ".firstSessionNegotiation";
    ...
    public static void main(String argv[])
    {
        ...
        RTKey.addRuntimeEntry(new RTKey.Entry(DMTP_1ST_SESSION_NEG, true, "DMTP allow 1st session custom event negotiation"));
