...
public class SendMail
{
    ...
    public static final String CONTENT_TYPE_PLAIN   = HTMLTools.CONTENT_TYPE_PLAIN;
    public static final String CONTENT_TYPE_GIF     = HTMLTools.CONTENT_TYPE_GIF;
    public static final String CONTENT_TYPE_JPEG    = HTMLTools.CONTENT_TYPE_JPEG;
    public static final String CONTENT_TYPE_PNG     = HTMLTools.CONTENT_TYPE_PNG;
    public static final String CONTENT_TYPE_OCTET   = HTMLTools.CONTENT_TYPE_OCTET;
    public static final String CONTENT_TYPE_CSV     = HTMLTools.CONTENT_TYPE_CSV;
    public static final String CONTENT_TYPE_CSV_OLD = HTMLTools.CONTENT_TYPE_CSV_OLD;
    public static final String CONTENT_TYPE_XML     = HTMLTools.CONTENT_TYPE_XML;
    public static final String CONTENT_TYPE_PDF     = HTMLTools.CONTENT_TYPE_PDF;
