...
public class Nmea0183
{
    ...
    **/
    ...
    private boolean _parse_GPRMC(String fld[])
    {
        ...
        // Format 2:
        // $GPRMC,025423.494,A,3709.0642,N,11907.8315,W,7.094,108.52,200505, , ,A*71
        ...
        if (fld.length > 12) {
            if (fld[11].indexOf('*') >= 0) {
                this.extraData = fld[12];
            } else
            if ((fld.length > 13) && (fld[12].indexOf('*') >= 0)) {
                this.extraData = fld[13];
            }
        }
