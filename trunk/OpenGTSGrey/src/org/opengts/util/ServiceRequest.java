...
public class ServiceRequest
{
    ...
    *** @param account      The Authorization account ID
    *** @param user         The Authorization user ID
    ...
    **/
        ...
        throws IOException
    {
        ...
        return HTMLTools.readPage_POST(this.getURL(), HTMLTools.CONTENT_TYPE_XML, xmlReq, timeoutMS);
    }
