        ...
        throws IOException
    {
        ...
        for (String mgn : menuMap.keySet()) {
            ...
            for (WebPage wp : mg.getWebPageList(reqState)) {
                ...
                String iconURI  = wp.getMenuIconImg();
                ...
                /* menu anchor/link */
                String anchorStart = null;
                if (wp instanceof WebPageURL) {
                    String target = ((WebPageURL)wp).getTarget();
                    anchorStart = "<a href='"+url+"' target='"+target+"'>";
                } else
                if (!StringTools.isBlank(menuHelp)) {
                    anchorStart = "<a href='"+url+"' title=\""+menuHelp+"\">";
                } else {
