    ...
    implements Constants
{
    ...
    private String _queueDeviceGroupProperties(DeviceGroup selGroup, User userAuth, HttpServletRequest request, I18N i18n)
    {
        ...
        try {
            devList = selGroup.getDevices(userAuth);
        ...
        throws IOException
    {
        ...
        /* argument group-id */
        OrderedSet<String> groupList = reqState.getDeviceGroupList(true); // non-null, length > 0
        ...
        if (deleteGroup) {
            ...
            try {
                ...
                groupList = reqState.getDeviceGroupList(true); // non-null, length > 0
        ...
        if (newGroup) {
            ...
            if (createGroupOK) {
                try {
                    ...
                    reqState.clearDeviceGroupList();
                    groupList = reqState.getDeviceGroupList(true);
                    selGroup = group;
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,Track.BASE_URI(),PAGE_MENU_TOP);
                    ...
                    out.write("<form name='"+FORM_GROUP_SELECT+"' method='post' action='"+selectURL+"' target='_top'>");
                    ...
                    out.write("<form name='"+FORM_GROUP_NEW+"' method='post' action='"+newURL+"' target='_top'>");
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,Track.BASE_URI(),PAGE_MENU_TOP);
                    ...
                    /* start of form */
                    out.write("<form name='"+FORM_GROUP_EDIT+"' method='post' action='"+editURL+"' target='_top'>\n");
                    ...
                    try {
                        OrderedSet<String> devList = DeviceGroup.getDeviceIDsForGroup(currAcct.getAccountID(), _selGroupID, null/*User*/);
                    ...
                    if (_editGroup) {
                        ...
                        out.write("<span style='padding-left:10px'>&nbsp;</span>\n");
                        out.write("<input type='button' name='"+PARM_BUTTON_CANCEL+"' value='"+i18n.getString("GroupInfo.cancel","Cancel")+"' onclick=\"javascript:openURL('"+editURL+"','_top');\">\n");
                    } else {
                        out.write("<input type='button' name='"+PARM_BUTTON_BACK+"' value='"+i18n.getString("GroupInfo.back","Back")+"' onclick=\"javascript:openURL('"+editURL+"','_top');\">\n");
                    }
                    out.write("</form>\n");
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                  ...
                  //String menuURL    = EncodeMakeURL(reqState,Track.BASE_URI(),PAGE_MENU_TOP);
                    ...
                    /* start of form */
                    out.write("<form name='"+FORM_PROPERTY_EDIT+"' method='post' action='"+editURL+"' target='_top'>\n");
