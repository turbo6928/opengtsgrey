...
//     -The current "<PrivateLabel>.getAliasName()" name is now used to set the 
    ...
    implements Constants
{
        ...
        throws IOException
    {
        ...
        try {
            ...
            /* create account */
            String aliasName = privLabel.getAliasName();
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CSS_NEW_ACCOUNT, m) {
            public void write(PrintWriter out) throws IOException {
              //String menuURL    = EncodeMakeURL(reqState, Track.BASE_URI(), PAGE_MENU_TOP);
                ...
                out.println("<form name='AccountInfo' method='post' action='"+emailURL+"' target='_top'>");
