    ...
    extends ReportMenu
{
    ...
    public ReportMenuDriverPerformance()
    {
        ...
        this.setPageName(PAGE_MENU_REPORT_PERFORM);
    ...
    public String getNavigationTab(RequestProperties reqState)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(ReportMenuDriverPerformance.class);
        return super._getNavigationTab(reqState,i18n.getString("ReportMenuDriverPerformance.navTab","Performance Reports"));
    }
