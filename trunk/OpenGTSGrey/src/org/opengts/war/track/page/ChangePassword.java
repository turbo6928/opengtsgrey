        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
              ...
              //String pwdURL  = EncodeMakeURL(reqState,Track.BASE_URI(),pageName,COMMAND_PWD_CHANGE);
                ...
                out.write("<hr/>\n");
                out.write("<form name='Passwd' method='post' action='"+pwdURL+"' target='_top'>\n");
                out.write("  <table>\n");
              ...
              //out.write("  <a href='"+menuURL+"'>"+i18n.getString("ChangePassword.cancel","Cancel")+"</a>\n");
                out.write("  <input type='button' name='"+PARM_BUTTON_CANCEL+"' value='"+i18n.getString("ChangePassword.cancel","Cancel")+"' onclick=\"javascript:openURL('"+menuURL+"','_top');\">\n");
                out.write("</form>\n");
            }
        };
