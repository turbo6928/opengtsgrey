    ...
    implements Constants
{
        ...
        throws IOException
    {
      ...
      //out.write("   alert('Report Option: ' + rptOption);\n");
        ...
        String emailMsg = i18n.getString("ReportMenu.emailFormat","Report will be emailed to the following ist of comma-separated email address(es):");
        ...
        throws IOException
    {
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
                ...
                String pageTarget = "_top"; // change to "_blank" to open reports in a separate page
                out.write("\n");
                ...
                /* device[group] list */
                out.write("<form id='"+FORM_DEVICE_GROUP+"' name='"+FORM_DEVICE_GROUP+"' method='post' action=\"javascript:rptmSubmitReport();\" target='_top''>\n");
                ...
                out.write("<form id='"+FORM_SELECT_REPORT+"' name='"+FORM_SELECT_REPORT+"' method='post' action=\"javascript:rptmSubmitReport();\" target='_top'>\n");
                ...
                for (int t = 0; t < ReportFactory.REPORT_TYPES.length; t++) {
                    ...
                    // include report type
                    String desc = ReportFactory.getReportTypeDescription(privLabel, type);
                ...
                out.write("    <hr>\n");
                out.write("    <form id='"+FORM_GET_REPORT+"' name='"+FORM_GET_REPORT+"' method='post' action=\"javascript:rptmSubmitReport();\" target='_top'>\n");
