    ...
    implements org.opengts.war.track.Constants
{
    ...
    public static final String MENU_REPORTS                 = "menu.reports";
    public static final String MENU_REPORTS_DETAIL          = "menu.reports.detail";
        // Device Detail[X]
        //      Event Detail[X]
        //      Temperature Monitoring[X]
        //      J1708 Fault codes[X]
    public static final String MENU_REPORTS_SUMMARY         = "menu.reports.summary";
        // Device Summary[X]
        //      Last known Device location[X]
        //      Last known Entity location[X]
    public static final String MENU_REPORTS_PERFORM         = "menu.reports.performance";
        // Driver Performance
        //      Excess Speed[X]
        //      Hard Braking
        //      Driving/Stop Time Report[X]
    public static final String MENU_REPORTS_IFTA            = "menu.reports.ifta";
        // IFTA
        //      Stateline Crossing Detail[X]
        //      State Mileage Summary[X]
        //      Fueling Detail
        //      Fueling Summary
    public static final String MENU_REPORTS_SYSADMIN        = "menu.reports.sysadmin";
        // SysAdmin
        //      Unassigned Devices
            ...
            if (mg.showInMenuBar()) {
                ...
                if (!ListTools.isEmpty(pageList)) {
                    ...
                    for (WebPage wp : pageList) {
                        ...
                        out.write("<td class='"+CSS_MENU_CELL+"' height='\"+itemHeight+\"' onclick=\\\"openURL('"+url+"','"+target+"');\\\" title=\\\""+help+"\\\">");
                        if (inclAnchor) {
        ...
        if (privLabel.getBooleanProperty(PrivateLabel.PROP_MenuBar_usePullDownMenus,DFT_USE_PULL_DOWN_MENUS)) {
            ...
            for (String mgn : menuMap.keySet()) {
                ...
                if (mg.showInMenuBar() && !ListTools.isEmpty(mg.getWebPageList(reqState))) {
                    String desc = mg.getTitle(privLabel.getLocale());
