...
public class PushpinIcon
{
    ...
    **/
    ...
    public static class TextIcon
    {
        ...
        public RenderedImage createTextImage(String text) {
            ...
            try {
                ...
                if (txLen > 0) {
                    ...
                    g2D.setColor((this.textColor != null)? this.textColor : Color.black);
                ...
                Print.logError("Unable to draw text into TextIcon: " + th);
