    ...
    implements WebPage
{
    ...
    **/
    ...
    public static String FormRow_TextNote(String description, String note)
    {
        ...
        sb.append("<tr>");
        /* description */
        sb.append("<td class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE_HEADER+"' valign='top' nowrap>"+description+"</td>");
        /* note */
        sb.append("<td class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE_DATA+"'>");
        sb.append(" ").append(StringTools.trim(note));
        sb.append("</td>");
        /* end row */
        sb.append("</tr>");
        /* return result */
    ...
    public static String FormRow_TextField(
        ...
        int size, int maxLen)
    {
        return FormRow_TextField(key, editable, description, value, size, maxLen, null);
    }
    ...
    public static String FormRow_TextField(
        ...
        String trailingHtml)
    {
        return FormRow_TextField(null, key, editable, description, value, null, size, maxLen, null);
    }
    ...
    protected static String Onclick_Confirm(Locale locale, String operation)
    {
        I18N i18n = I18N.getI18N(WebPageAdaptor.class, locale);
        String confirmOp = i18n.getString("WebPageAdapter.confirmOperation",
            "Are you sure you want to {0} the selected item?", StringTools.trim(operation));
    ...
    {
        return this.getPageNavigationHTML(reqState, false);
    }
    ...
    public void setMenuIconImg(String iconURI)
    {
    ...
    public void setMenuIconAlt(String iconURI)
    {
        if (StringTools.isBlank(iconURI) || iconURI.startsWith("!")) {
            this.imageAlt = null;
        } else {
            this.imageAlt = iconURI;
        }
    }
        ...
        throws IOException
    {
        ...
        if (reqState.getEncodeEMailHTML()) {
