    ...
    implements DBRecordListener<gDBR>
{
    ...
    ***/
        ...
        boolean editable, boolean viewable) 
    {
        ...
        /* optional? */
        this.setOptional((StringTools.className(this.rcdClass).indexOf(".opt.") >= 0));
    ...
    **/
    public boolean validateColumns(int validateMask, boolean refreshColumns)
    {
        ...
        if (addMissingColumns && (missingColumns.size() > 0)) {
            try {
                boolean rebuildAltIndexes = false;
                for (Iterator<DBField> i = missingColumns.iterator(); i.hasNext();) {
                    DBField col = i.next();
                    this.addColumn(col);
                    if (col.isAlternateKey()) {
                        rebuildAltIndexes = true;
                    }
                }
                if (rebuildAltIndexes) {
        ...
        if (alterColumnTypes && (typeMismatchColumns.size() > 0)) {
            try {
                for (Iterator<DBField> i = typeMismatchColumns.iterator(); i.hasNext();) {
                    DBField col = i.next();
                    this.addColumn(col);
                }
            } catch (DBException dbe) {
    ...
    **/
        ...
        throws DBException 
    {
        ...
        for (int i = 0; i < pk.length; i++) {
            String name = pk[i].getName();
            String sval = valMap.get(name); // may defined, but null
    ...
    **/
        ...
        throws DBException 
    {
        ...
        NodeList fieldNodes = record.getElementsByTagName(TAG_Field);
    ...
    **/
        ...
        throws DBException
    {
        ...
        try {
            ...
            stmt = DBFactory.execute(dsel.toString()); // may throw DBException, SQLException
    ...
    **/
    public boolean validateTable(boolean inclWarn)
    {
        ...
        try {
            ...
            DBSelect<gDBR> dsel = new DBSelect<gDBR>(this);
            Statement stmt = DBFactory.execute(dsel.toString(), true); // needs to be row-by-row
    ...
    *** @throws DBException   If a database error occurs
    **/
    public void addColumn(DBField col)
        throws DBException
    {
        if (col != null) {
            try {
    ...
    *** @throws DBException   If a database error occurs
    **/
    protected void _addColumn(DBField col)
        ...
        throws DBException
    {
        ...
        try {
            ...
            try {
                ...
                sqlStatement = DBFactory.execute(dsel.toString(), true); // row by row
            ...
            while (sqlResultSet.next()) {
                ...
                if (outFmt == DUMP_FORMAT_CSV) {
                    ...
                    for (int i = 0; i < fields.length; i++) {
                        ...
                        Object r = fields[i].getResultSetValue(sqlResultSet);
                        String v = (r != null)? r.toString() : "";
                      //String v = sqlResultSet.getString(n);
                ...
                if (outFmt == DUMP_FORMAT_XML) {
                    ...
                    for (int i = 0; i < fields.length; i++) {
                        String value = DBFieldValues.toStringValue(fields[i].getResultSetValue(sqlResultSet));
            ...
            if (sqlResultSet  != null) { try{ sqlResultSet.close();  } catch (SQLException sqe) {} }
            if (sqlStatement  != null) { try{ sqlStatement.close();  } catch (SQLException sqe) {} }
        }
    ...
    **/
        ...
        throws DBException, SQLException, IOException
    {
        ...
        try {
            ...
            sqlStatement = DBFactory.execute(sbSql.toString());
        } catch (SQLException sqe) {
    ...
    **/
    protected static Statement execute(String sql, boolean rowByRow) 
        throws SQLException, DBException
    {
        return DBConnection.getDefaultConnection().execute(sql, rowByRow);
    }
    ...
    **/
        ...
        throws DBException
    {
        ...
        /* parse fields */
        NodeList fieldList = node.getElementsByTagName(TAG_Field);
