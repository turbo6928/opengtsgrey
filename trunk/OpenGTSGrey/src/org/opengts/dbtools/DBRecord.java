  ...
  //private   DBFieldValues             fieldVals               = null;
    ...
    **/
        ...
        throws DBException
    {
        ...
        try {
            stmt = DBRecord.execute(dsel.toString());
    ...
    **/
    ...
    protected static long executeUpdate(String sql, boolean rtnAutoIncrVal)
        throws SQLException, DBException
    {
        return DBConnection.getDefaultConnection().executeUpdate(sql, rtnAutoIncrVal);
    }
    ...
    **/
        ...
        throws DBException
    {
        try {
            ...
            fldVals.setFieldValues(rs, false); // should not reset the primary key fields
        } catch (SQLException sqe) {
            this.setLastCaughtSQLException(sqe);
    ...
    **/
        ...
        throws DBException
    {
        DBFieldValues fldVals = this.getRecordKey().getFieldValues();
        fldVals.clearFieldValues(); // does not clear the primary key
        fldVals.setFieldValues(valMap, false); // should not reset the primary key fields
    }
