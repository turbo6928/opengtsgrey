...
public class DBFieldValues
{
    ...
    *** @throws SQLException If field does not exist
    **/
    public void setFieldValues(ResultSet rs, boolean setKeyFields) 
        throws SQLException
    {
        if (this.recordKey != null) {
    ...
    **/
    public void setFieldValues(Map<String,String> valMap) 
        throws DBException
    {
        this.setFieldValues(valMap, true);
    }
    ...
    *** @throws DBException If field does not exist
    **/
    public void setFieldValues(Map<String,String> valMap, boolean setKeyFields) 
        throws DBException
    {
        if (this.recordKey != null) {
            String tblName = this.getTableName();
            ...
            for (int i = 0; i < fld.length; i++) {
                if (setKeyFields || !fld[i].isPrimaryKey()) {
                    ...
                    //} else
                    //if (this.getIgnoreInvalidFields() || ignoreMissing) {
                    //    Print.logWarn("Field not found - " + name + " (ignored)");
                    } else {
    ...
    **/
    public boolean hasField(String fldName)
    {
        ...
        return (fldName != null)? this.fieldMap.containsKey(fldName) : false;
    }
