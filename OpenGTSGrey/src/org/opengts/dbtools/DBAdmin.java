    ...
    **/
    public static void printTableSchema(int docWidth, String header[], String tableName)
    {
        ...
        for (Iterator<String> i = factMap.keyIterator(); i.hasNext();) {
            ...
            Print.sysPrintln("");
            DBAdmin._printHeaderText(f.getDescription(null), docWidth);
            Print.sysPrintln("");
            ...
            for (int c = 0; c < colDef.length; c++) {
                ...
                String  title   = colDef[c].getTitle(null);
    ...
    public static DBAdminExec execCommands() // return
    {
        ...
        if (reloadTable != null) {
            ...
            try {
                ...
                Print.logError("Unable to drop table: " + reloadTable);
                dbe.printException();
            ...
            try {
                ...
                Print.logException("Error retrieve table record count: " + reloadTable, th);
                return DBAdminExec.ERROR;
            }
        ...
        if (loadTable != null) {
            ...
            if (p < 0) {
                ...
                if (ext.equals(DBFactory._LOAD_EXT_CSV) || ext.equals(DBFactory._LOAD_EXT_TXT) || ext.equals(DBFactory._LOAD_EXT_SQL)) {
                    ...
                    if (!loadFile.isFile()) {
                        Print.logError("'Load' file not found: " + loadFile);
                        return DBAdminExec.ERROR;
                    }
                } else {
