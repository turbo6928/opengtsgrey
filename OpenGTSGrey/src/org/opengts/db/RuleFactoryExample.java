    ...
    extends RuleFactoryAdapter
{
    ...
    //    initialization class "StartupInit.java".  Exmine this source module for
    ...
    // complex grammer (such as an SQL 'where' clause) that has it's own lexer/parser.
    //
    ...
    private RuleFunction getFunction(String selector)
    {
        if (StringTools.isBlank(selector)) {
            ...
            int p = selector.indexOf(ARG_SEPARATOR_CHAR);
    ...
    public boolean checkSelectorSyntax(String selector) 
    {
        ...
        if (StringTools.isBlank(selector)) {
            ...
            return this.ftnMap.containsKey(selector);
        }
    }
    ...
    public int executeRules(EventData event) 
    {
        ...
        /* exectue rules, and perform appropriate action */
