...
//     -Added boolean field "zoomRegion"
    ...
    extends AccountRecord<Geozone>
{
    ...
    */
    ...
    private static DBField FieldInfo[] = {
        ...
        new DBField(FLD_geozoneID      , String.class  , DBField.TYPE_STRING(32)  , "Geozone ID"      , "key=true export=true"),
    ...
    **/
    ...
    private static void usage()
    {
        ...
        Print.logInfo("  -csv=<file>       Create CSV file for client devices");
    ...
    public static void main(String argv[])
    {
        ...
        if (RTConfig.hasProperty(ARG_EVTEST)) {
            ...
            try {
                ...
                EventData ed[] = EventData.getRangeEvents(acctID, devID, dte-1, dte+1, null, true, null, 0L, true, null);
