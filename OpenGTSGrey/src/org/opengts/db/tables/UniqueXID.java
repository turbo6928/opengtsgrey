    ...
    extends DBRecord<UniqueXID>
{
    ...
    {
        return RTConfig.getBoolean(DBConfig.UNIQUEXID_QUERY_ENABLED);
    }
    ...
    private static DBField FieldInfo[] = {
        new DBField(FLD_uniqueID        , String.class  , DBField.TYPE_STRING(40)  , "Unique ID"    , "key=true"),
        new DBField(FLD_accountID       , String.class  , DBField.TYPE_STRING(32)  , "Account ID"   , "edit=2"),
        new DBField(FLD_transportID     , String.class  , DBField.TYPE_STRING(32)  , "Transport ID" , "edit=2"),
    };
