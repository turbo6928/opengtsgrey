    ...
    implements DataTransport
{
    ...
    {
        return RTConfig.getBoolean(DBConfig.TRANSPORT_QUERY_ENABLED);
    }
    ...
    private static DBField FieldInfo[] = {
        ...
        new DBField(FLD_transportID          , String.class        , DBField.TYPE_STRING(32)  , "Transport ID"                  , "key=true"),
        new DBField(FLD_assocAccountID       , String.class        , DBField.TYPE_STRING(32)  , "Associated Account ID"         , "edit=2 altkey=device"),
        new DBField(FLD_assocDeviceID        , String.class        , DBField.TYPE_STRING(32)  , "Associated Device ID"          , "edit=2 altkey=device"),
        // DataTransport fields
        new DBField(FLD_uniqueID             , String.class        , DBField.TYPE_STRING(40)  , "Unique ID"                     , "edit=2 altkey=altIndex"),
