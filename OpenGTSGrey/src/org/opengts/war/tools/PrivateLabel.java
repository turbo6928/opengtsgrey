    ...
    extends BasicPrivateLabel
{
    ...
    **/
    ...
    {
        return PrivateLabel._readOfflineMessage(RTConfig.getFile(DBConfig.TRACK_OFFLINE_FILE,null),"Global");
    }
    ...
    **/
    public Map<String,JSPEntry> getJSPMap()
    {
        return this.jspMap;
    }
    ...
    **/
    ...
    {
        Map<String,JSPEntry> map = this.getJSPMap();
        if (map != null) {
            JSPEntry je = map.get(jspName);
            if (je != null) {
                return je;
            }
        }
