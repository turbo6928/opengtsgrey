...
public interface MapProvider
{
    ...
    public static final String  ID_ZONE_LATITUDE[]          = new String[] {
        ID_ZONE_LATITUDE_ + "0",
        ID_ZONE_LATITUDE_ + "1",
        ID_ZONE_LATITUDE_ + "2",
        ID_ZONE_LATITUDE_ + "3",
    ...
    public static final String  ID_ZONE_LONGITUDE[]         = new String[] {
        ID_ZONE_LONGITUDE_ + "0",
        ID_ZONE_LONGITUDE_ + "1",
        ID_ZONE_LONGITUDE_ + "2",
        ID_ZONE_LONGITUDE_ + "3",
        ID_ZONE_LONGITUDE_ + "4",
        ID_ZONE_LONGITUDE_ + "5",
    };
    ...
    public static final String  PROP_zone_map_multipoint[]  = new String[] { "zone.map.multipoint",   "geozone.multipoint"       };  // boolean (supports multiple points)
