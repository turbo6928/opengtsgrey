    ...
    implements Constants
{
    ...
    public static final String MENU_EXPANDABLE      = "expand";
        ...
        throws IOException
    {
        ...
        HTMLOutput HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_MENU, pageMsg) {
            public void write(PrintWriter out) throws IOException {
                ...
                /* frame header */
                if (privLabel.getBooleanProperty(PrivateLabel.PROP_TopMenu_showHeader,true)) {
                ...
                switch (menuType) {
                    case FIXED: {
                        ...
                        ExpandMenu.writeMenu(out, reqState, "topMenuFixed", false, descriptionType, menuHelp);
                    } break;
                    case EXPAND: {
                        boolean menuHelp = privLabel.getBooleanProperty(PrivateLabel.PROP_TopMenu_showMenuHelp,true);
                        ExpandMenu.writeMenu(out, reqState, "topMenuExpand", true, descriptionType, menuHelp);
                    } break;
                    case ICON: {
                        int maxIPR = privLabel.getIntProperty(PrivateLabel.PROP_TopMenu_maximumIconsPerRow,-1);
                        IconMenu.writeMenu(out, reqState, "topMenuIcon", maxIPR);
                    } break;
                }
