        ...
        HTMLOutput HTML_CONTENT  = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
            public void write(PrintWriter out) throws IOException {
              ...
              //String chgURL  = EncodeMakeURL(reqState,Track.BASE_URI(),pageName,COMMAND_INFO_UPDATE);
                ...
                out.println("<hr/>");
                out.println("<form name='AccountInfo' method='post' action='"+chgURL+"' target='_top'>");
                ...
                out.println(FormRow_TextField(PARM_NOTIFY_EMAIL , _allowEdit, i18n.getString("AccountInfo.notifyEMail","Notify Email:")              , currAcct.getNotifyEmail()     , 80, 110));
              ...
              //out.println(FormRow_TextField(PARM_GROUP_TITLE  , _allowEdit, i18n.getString("AccountInfo.groupTitle","'DeviceGroup' Title:")        , grpTitles[0]                  , 20, 40));
                ...
                if (_allowEdit) {
                    ...
                    out.write("<span style='padding-left:10px'>&nbsp;</span>\n");
                    out.write("<input type='button' name='"+PARM_BUTTON_CANCEL+"' value='"+i18n.getString("AccountInfo.cancel","Cancel")+"' onclick=\"javascript:openURL('"+menuURL+"','_top');\">\n");
                } else {
                    out.write("<input type='button' name='"+PARM_BUTTON_BACK+"' value='"+i18n.getString("AccountInfo.back","Back")+"' onclick=\"javascript:openURL('"+menuURL+"','_top');\">\n");
                }
                out.write("</form>\n");
