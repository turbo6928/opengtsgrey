    ...
    extends ReportMenu
{
    ...
    public ReportMenuDeviceDetail()
    {
        ...
        this.setPageName(PAGE_MENU_REPORT_DETAIL);
    ...
    {
        return MenuBar.MENU_REPORTS_DETAIL;
    }
    ...
    public String getNavigationDescription(RequestProperties reqState)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(ReportMenuDeviceDetail.class);
        return super._getNavigationDescription(reqState,i18n.getString("ReportMenuDeviceDetail.navDesc","Detail Reports"));
    }
    ...
    public String getNavigationTab(RequestProperties reqState)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(ReportMenuDeviceDetail.class);
        return super._getNavigationTab(reqState,i18n.getString("ReportMenuDeviceDetail.navTab","Detail Reports"));
    }
